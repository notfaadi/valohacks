	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/best-valorant-cheats/', labelKey: 'homeSeo.linkCloudDma' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/undetected-valorant-cheats/', labelKey: 'homeSeo.linkUndetected' },
				{ href: '/vanguard-bypass/', labelKey: 'homeSeo.linkVanguard' },
